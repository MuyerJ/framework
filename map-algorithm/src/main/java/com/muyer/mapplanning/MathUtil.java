...
public class MathUtil {
    ...
    public static class AddOptionChain {
        private double v1;

        public AddOptionChain(double v1){
            this.v1 = v1;
        }

        public AddOptionChain add(double v2) {
            v1 = MathUtil.add(v1, v2);
            return this;
        }
     ...
     * @return 四舍五入后的结果
     */
    public static double roundCeil(double v, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException("The scale must be a positive integer or zero");
        }
        BigDecimal b = new BigDecimal(Double.toString(v));
